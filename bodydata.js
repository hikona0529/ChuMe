// --- Config & State ---
        ...
        function renderCalendar() {
            ...
            // --- WEEKLY DATA CHECK LOGIC ---
            // For weekly, we generally save one record per week (or any date).
            // Since the storage is simply a list of records with dates, simple date matching works for both.
            // If a date exists in the history array, it means data was saved for that day.
